...
sudo("apt-get install -y goaccess") or die("Unable to install goaccess.")
...
sudo("curl -o "+rachel_dir+"/admin/https://raw.githubusercontent.com/june23rd1987/rachelpiOS/refs/heads/master/install.php") or die("Unable to update install.php")
...
sudo("curl -o "+rachel_dir+"/admin/art/login.png https://raw.githubusercontent.com/june23rd1987/rachelpiOS/refs/heads/master/global_hope.png") or die("Unable to global_hope.png")
