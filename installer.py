...
sudo("sh -c 'echo \"extension=stem.so\" >> /etc/php/8.1/cli/php.ini'") or die("Unable to install stemmer CLI config 8.1")
#######sudo("sh -c 'echo \"extension=stem.so\" >> /etc/php/7.4/apache2/php.ini'") or die("Unable to install stemmer Apache config 7.4")
sudo("sh -c 'echo \"extension=stem.so\" >> /etc/php/8.1/apache2/php.ini'") or die("Unable to install stemmer Apache config 8.1")
